"Argument definitions for pretrain_unified_navit.py."
...
class TrainingArguments:
    ...
    enable_wandb: bool = field(
        default=True,
        metadata={"help": "Enable Weights & Biases logging. Set to False to disable wandb completely."}
    )
    ...
    del_previous_state: bool = field(
        default=False,
        metadata={"help": "Delete previous optimizer/scheduler states after saving ckpt."}
    )
    ...
    auto_resume: bool = field(
        default=False,
        metadata={"help": "Automatically pick up the latest checkpoint found in checkpoint_dir (overrides resume_from)."}
    )
